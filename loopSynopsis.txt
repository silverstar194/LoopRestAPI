...
Overview:
	I designed and developed Loop over winter break. The app utilizes PhoneGap to be across platforms (both IOS and Android) . The front end is HTML (styled with CSS) and javascript while the server side is written in Java as a RESTful API. All user information and posts are held in a MySQL database.
